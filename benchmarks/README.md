...
- `article_vii_capacity_accumulation_tracking.md` — longitudinal capacity-accumulation schema (Article VII, v0.4 constitutional layer); operationalizes the capacity-vs-truth distinction across cases
